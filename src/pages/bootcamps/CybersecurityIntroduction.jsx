      ...
      <section className="relative w-full px-6 lg:px-16 pt-10 pb-20 lg:py-8 flex flex-col lg:flex-row items-center justify-between gap-10 min-h-[calc(100vh-5rem)] overflow-visible">
        ...
        <div className="flex-1 space-y-5 relative z-10 w-full" style={{ textAlign: isRtl ? 'right' : 'left' }}>
          ...
          >
            ...
            {t('cyberIntroTag', '12 Weeks Program')}
          </div>
          ...
          <h1 className="hero-element text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold leading-tight font-heading text-white drop-shadow-lg">
            {t('cyberIntroHeroTitle1')}{' '}
            <span style={{ color: primaryColor, textShadow: `0 0 20px rgba(255,23,23,0.5)` }}>{t('cyberIntroHeroHighlight')}</span>
            <br />{t('cyberIntroHeroTitle2')}
          </h1>

          <p className="hero-element text-base md:text-lg text-slate-400 max-w-lg leading-relaxed">
            {t('cyberIntroHeroSubtitle')}
          </p>
        ...
        <div className="hero-element flex-1 w-full max-w-sm sm:max-w-md md:max-w-lg mx-auto relative group mt-8 mb-10 lg:my-0 px-6 sm:px-0">
          ...
          <div className="relative bg-slate-900 rounded-[2rem] border border-slate-700 shadow-[0_0_50px_rgba(255,23,23,0.15)] p-5 sm:p-6 flex flex-col gap-4 transform -rotate-1 sm:-rotate-2 transition-transform duration-500 group-hover:rotate-0 z-10 overflow-hidden">
            ...
            {/* Fake Content Area */}
            <div className="flex-1 rounded-xl bg-slate-950 border border-slate-800 p-4 relative overflow-hidden font-mono text-xs">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16 space-y-4">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-xs font-semibold bg-red-500/10 text-red-500 border border-red-500/20 mb-4">
              <TargetIcon /> {t('cyberIntroCertTitle')}
            </div>
            <h2 className="text-4xl lg:text-5xl font-bold font-heading text-white">{t('cyberIntroCertSubtitle')}</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="cert-card glass-panel rounded-2xl p-8 flex flex-col group hover:border-[#FF1717]/50 transition-all duration-300 hover:shadow-[0_0_30px_rgba(255,23,23,0.1)] hover:-translate-y-2">
               ...
               <h3 className="text-xl font-bold font-heading text-white mb-3">{t('cyberIntroCard1Title')}</h3>
               <p className="text-slate-400 text-sm leading-relaxed">{t('cyberIntroCard1Desc')}</p>
            </div>
            ...
            <div className="cert-card glass-panel rounded-2xl p-8 flex flex-col group hover:border-[#FF1717]/50 transition-all duration-300 hover:shadow-[0_0_30px_rgba(255,23,23,0.1)] hover:-translate-y-2">
               ...
               <h3 className="text-xl font-bold font-heading text-white mb-3">{t('cyberIntroCard2Title')}</h3>
               <p className="text-slate-400 text-sm leading-relaxed">{t('cyberIntroCard2Desc')}</p>
            </div>
            ...
            <div className="cert-card glass-panel rounded-2xl p-8 flex flex-col group hover:border-[#FF1717]/50 transition-all duration-300 hover:shadow-[0_0_30px_rgba(255,23,23,0.1)] hover:-translate-y-2">
               ...
               <h3 className="text-xl font-bold font-heading text-white mb-3">{t('cyberIntroCard3Title')}</h3>
               <p className="text-slate-400 text-sm leading-relaxed">{t('cyberIntroCard3Desc')}</p>
            </div>
            ...
            <div className="cert-card bg-gradient-to-br from-red-600 to-red-900 rounded-2xl p-8 flex flex-col group hover:-translate-y-2 transition-all duration-300 shadow-[0_10px_40px_rgba(255,23,23,0.3)] border border-red-500/50 relative overflow-hidden">
               ...
               <div className="w-14 h-14 rounded-xl bg-white/10 flex items-center justify-center mb-6 text-white group-hover:scale-110 transition-all duration-300 backdrop-blur-sm border border-white/20">
                 <ShieldIcon />
               </div>
               <h3 className="text-xl font-bold font-heading text-white mb-3 relative z-10">{t('cyberIntroCard4Title')}</h3>
               <p className="text-white/80 text-sm leading-relaxed relative z-10">{t('cyberIntroCard4Desc')}</p>
            </div>
      ...
      <section id="curriculum" className="py-24 bg-slate-950" ref={curriculumRef}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="curriculum-header text-center mb-16 space-y-4">
            <h2 className="text-4xl lg:text-5xl font-bold font-heading text-white">{t('cyberIntroCurriculumTitle')}</h2>
            <p className="text-lg text-slate-400 max-w-2xl mx-auto">
              {t('cyberIntroCurriculumSubtitle')}
            </p>
          </div>

          <div className="grid md:grid-cols-2 gap-6">
            {(t('cyberIntroCurriculumModules', { returnObjects: true }) || []).map((mod, i) => (
              <div
                key={i}
            ...
            <div className="md:w-3/5 p-10 md:p-14 bg-slate-950">
              ...
              <form className="space-y-5" onSubmit={async (e) => { 
                ...
                <div className="space-y-1.5">
                  <label htmlFor="name" className="text-sm font-semibold text-slate-400">{t('formName')}</label>
                  <input type="text" id="name" className="input w-full bg-slate-900 border-slate-800 text-white focus:border-red-500/50 focus:ring-red-500/20" placeholder="Ahmed Benali" value={formData.name} onChange={(e) => setFormData({...formData, name: e.target.value})} required />
                </div>
                <div className="space-y-1.5">
                  <label htmlFor="email" className="text-sm font-semibold text-slate-400">{t('formEmail')}</label>
                  <input type="email" id="email" className="input w-full bg-slate-900 border-slate-800 text-white focus:border-red-500/50 focus:ring-red-500/20" placeholder="ahmed@example.com" value={formData.email} onChange={(e) => setFormData({...formData, email: e.target.value})} required />
                </div>
                <div className="space-y-1.5">
                  <label htmlFor="phone" className="text-sm font-semibold text-slate-400">{t('formPhone')}</label>
                  <div className="flex" dir="ltr">
                    ...
                    <input type="tel" id="phone" className="input rounded-l-none w-full bg-slate-900 border-slate-800 text-white focus:border-red-500/50 focus:ring-red-500/20" placeholder="555 123 456" value={formData.phone} onChange={(e) => setFormData({...formData, phone: e.target.value})} required />
                  </div>
                </div>
                <button
                  type="submit"
